...
import 'package:shubham_flutter/pages/chat_page.dart';
...
class _SearchPageState extends State<SearchPage> {
  ...
  Widget groupTile(String userName, String groupId, String groupName, String admin){
    // function to chcck whether user already existed in group
    joinedOrNot(userName,groupId,groupName,admin);
      return ListTile(
        ...
        title:
        Text(groupName, style: TextStyle(fontWeight: FontWeight.w600),),
